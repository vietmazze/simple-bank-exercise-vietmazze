...
contract SimpleBank {
    ...
    function getEnrolled(address _addr) public view returns (bool) {
      return enrolled[_addr];
    }
    ...
    function deposit() public payable onlyEnroll returns (uint) {
    ...
    function withdraw(uint withdrawAmount) public enoughBalance(withdrawAmount) returns (uint) {
